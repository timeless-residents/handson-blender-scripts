...
def setup_material(obj):
    ...
    # ノードを接続
    mat.node_tree.links.new(vertex_color.outputs["Color"], principled.inputs["Base Color"])
    mat.node_tree.links.new(principled.outputs["BSDF"], nodes.new("ShaderNodeOutputMaterial").inputs["Surface"])
...
def setup_lighting():
    ...
    world.node_tree.links.new(bg.outputs["Background"], nodes.new("ShaderNodeOutputWorld").inputs["Surface"])
